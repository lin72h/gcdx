#!/usr/bin/env python3
"""Compare live pressure-provider smoke artifacts against the checked-in baseline."""
...
CAPTURE_EQUAL_FIELDS = ("label", "interval_ms", "duration_ms")
...
def compare_capture(label: str, baseline_capture: dict | None, candidate_capture: dict | None):
    ...
    for field in ("generation_contiguous", "monotonic_increasing"):
